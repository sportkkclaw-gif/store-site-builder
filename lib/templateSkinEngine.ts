...
.template-hero{width:100%;padding:0 var(--site-hero-padding-x);position:relative;isolation:isolate}.template-hero-inner{position:relative;isolation:isolate;overflow:hidden;width:100%;max-width:var(--site-hero-max,1360px);min-height:var(--artwork-hero-desktop,620px);margin:0 auto;border-radius:34px;padding:clamp(34px,5vw,72px);display:flex;align-items:center;border:${skin.hero.panelBorder};box-shadow:${skin.productCard.shadow};background:#111}.template-hero-backplate{position:absolute;inset:0;width:100%;height:100%;z-index:0;object-fit:var(--artwork-fit,cover);object-position:var(--artwork-position,${skin.artwork.objectPosition})}.mobile-hero-artwork-stage{display:none}.mobile-artwork-safe-frame{width:100%;max-width:100%;overflow:hidden;position:relative;box-sizing:border-box;border-radius:var(--mobile-artwork-radius,22px);background:var(--mobile-artwork-src) center/cover no-repeat,rgba(255,255,255,.18);aspect-ratio:16/9;min-height:170px;max-height:230px}.mobile-artwork-safe-frame img,.mobile-artwork-image{display:block;position:absolute;inset:0;width:100%;height:100%;max-width:none;max-height:none;box-sizing:border-box;margin:0;transform:none;object-fit:cover;object-position:center top}.mobile-artwork-overlay{position:absolute;inset:0;pointer-events:none;background:linear-gradient(180deg,rgba(255,255,255,.12),rgba(0,0,0,.10)),var(--mobile-artwork-overlay,transparent);opacity:.32}.mobile-artwork-safe-frame[data-mobile-artwork-mode='artwork-backdrop'] img,.mobile-artwork-safe-frame[data-mobile-artwork-mode='background-soft'] img{filter:blur(1.5px) saturate(1.08);transform:scale(1.04)}.mobile-artwork-safe-frame[data-mobile-artwork-mode='hero-crop-safe'] img,.mobile-artwork-safe-frame[data-mobile-artwork-mode='safe-cover'] img{object-fit:cover;object-position:center top}.mobile-artwork-safe-frame[data-mobile-artwork-mode='section-accent']{aspect-ratio:16/7;min-height:140px}.mobile-artwork-safe-frame[data-mobile-artwork-mode='cropped-window']{aspect-ratio:16/10}.template-hero-overlay{position:absolute;inset:0;z-index:1;background:var(--artwork-overlay,${skin.artwork.overlay})}.hero-copy{position:relative;z-index:2;width:min(54%,760px);min-width:560px;border-radius:28px;background:${skin.hero.panelBackground};padding:clamp(28px,4vw,48px);border:${skin.hero.panelBorder};box-shadow:0 24px 70px rgba(0,0,0,.22);backdrop-filter:blur(18px);overflow:visible}.hero-copy h1{margin:0;max-width:100%;font-size:clamp(48px,5.4vw,82px);line-height:1.02;letter-spacing:-.045em;color:${skin.hero.headingColor};text-wrap:balance;white-space:normal;word-break:normal;overflow-wrap:normal}.hero-title-line{display:inline}.hero-copy .muted{color:${skin.hero.subtitleColor};max-width:100%;overflow-wrap:normal}.skin-link-list{max-width:100%}
...
@media(max-width:760px){.store-template,.export-site{${generateMobileHeroLayoutCssVariables()};overflow-x:hidden}.store-template .wrap,.export-site.wrap{padding:8px;gap:16px;max-width:100%;overflow-x:hidden}.skin-nav{width:100%;margin:0;border-radius:22px;min-width:0}.skin-nav nav{display:none}.template-hero{padding:0;overflow:hidden}.template-hero-inner{width:100%;max-width:100%;min-height:auto;padding:12px 0 16px;align-items:center;justify-content:flex-start;flex-direction:column;gap:14px;border-radius:24px;overflow:hidden;background:${skin.section.background}}.template-hero-backplate,.template-hero-overlay{display:none}.mobile-hero-artwork-stage{display:block;width:100%;max-width:100%;margin-inline:auto;padding-inline:0;overflow:hidden;box-sizing:border-box;border-radius:24px}.mobile-artwork-safe-frame{width:calc(100% - 16px);max-width:100%;margin-inline:auto;overflow:hidden;display:block;box-sizing:border-box;border-radius:var(--mobile-artwork-radius,24px);min-height:clamp(230px,64vw,290px);height:clamp(230px,64vw,290px);max-height:310px}.mobile-artwork-safe-frame[data-mobile-artwork-mode="fill-safe-top"],.mobile-artwork-safe-frame[data-mobile-artwork-mode="fill-safe"],.mobile-artwork-safe-frame[data-mobile-artwork-mode="fill-safe-center"]{width:100%;min-height:clamp(250px,68vw,300px);height:clamp(250px,68vw,300px)}.mobile-artwork-safe-frame[data-mobile-artwork-mode="contain-safe"] img{object-fit:contain}.mobile-artwork-safe-frame img{width:100%;height:100%;display:block;max-width:none;max-height:none;object-fit:cover;object-position:top center;transform:none;margin:0;min-width:0}.mobile-artwork-safe-frame[data-mobile-artwork-mode="fill-safe-center"] img{object-position:center center}.hero-copy,.mobile-hero-content-panel{width:min(100%,340px);max-width:var(--mobile-hero-panel-max-width);min-width:0;margin:0 auto;box-sizing:border-box;padding:clamp(22px,6vw,32px);border-radius:28px;overflow:hidden}.hero-copy h1,.mobile-hero-title{width:100%;max-width:var(--mobile-hero-title-max-width);font-size:var(--mobile-hero-title-font-size);line-height:var(--mobile-hero-title-line-height);letter-spacing:-.02em;white-space:normal;word-break:normal;overflow-wrap:normal;line-break:strict;text-wrap:balance;display:-webkit-box;-webkit-line-clamp:var(--mobile-hero-title-max-lines);-webkit-box-orient:vertical;overflow:visible}.hero-title-line{display:block}.hero-copy .muted{font-size:var(--mobile-hero-subtitle-font-size);line-height:var(--mobile-hero-subtitle-line-height);white-space:normal;word-break:normal;overflow-wrap:normal}.skin-link-list{display:flex;flex-wrap:wrap;max-width:100%;gap:10px}.skin-btn{max-width:100%;white-space:normal;text-align:center;overflow-wrap:normal}.skin-section,.skin-footer{width:100%;padding:20px;border-radius:22px}.product-grid,.info-grid,.faq-list{grid-template-columns:1fr}.skin-menu-row{padding:12px;flex-direction:column}.product-img,.themed-placeholder{height:150px;min-height:150px}.skin-footer{margin-bottom:0}}@media(max-width:360px){.store-template,.export-site{${generateMobileHeroLayoutCssVariables(320)}}.hero-copy,.mobile-hero-content-panel{width:min(100%,272px);max-width:calc(100% - 40px);min-width:0;padding:18px}.template-hero-inner{padding:10px 0 14px}}
`;
}
