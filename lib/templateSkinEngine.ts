      ...
      : skin.page.texture === 'bubbles'
        ...
        : skin.page.texture === 'charcoal'
          ...
          : skin.page.texture === 'botanical'
            ...
            : 'none';
  return `
.store-template,.export-site{${generateTemplateLayoutCssVariables()};font-family:inherit;min-height:100%;width:100%;overflow:hidden;background:${skin.page.background};color:${skin.page.textColor}}
...
@media(max-width:760px){.store-template .wrap,.export-site.wrap{padding:14px;gap:16px}.skin-nav{width:100%;margin:0;border-radius:22px}.skin-nav nav{display:none}.template-hero{padding:0}.template-hero-inner{min-height:var(--artwork-hero-mobile,760px);padding:18px;align-items:flex-end;border-radius:24px}.hero-copy{width:100%;min-width:0;padding:20px}.hero-copy h1{font-size:clamp(34px,10vw,48px)}.skin-section,.skin-footer{width:100%;padding:20px;border-radius:22px}.product-grid,.info-grid,.faq-list{grid-template-columns:1fr}.skin-menu-row{padding:12px;flex-direction:column}.product-img,.themed-placeholder{height:150px;min-height:150px}.skin-footer{margin-bottom:0}}
`;
}
