...
export function ThemedHero({ data, skin }: { data: SiteData; skin: TemplateSkin }) {
  ...
  return <section className="template-hero" data-testid="site-hero" data-skin-component="hero" data-skin-family={skin.family} data-artwork-source="true" data-artwork-src={artwork.gallerySrc} data-panel={artwork.backplate.textPanelMode} data-panel-position={artwork.backplate.textPanelPosition} data-contrast={artwork.backplate.textContrast} style={{ '--artwork-overlay': artwork.backplate.overlay, '--artwork-hero-desktop': artwork.backplate.heroHeightDesktop, '--artwork-hero-mobile': artwork.backplate.heroHeightMobile, '--artwork-fit': heroObjectFit(artwork.backplate.cropMode), '--artwork-position': heroObjectPosition(artwork.backplate.cropMode) } as CSSProperties}>
